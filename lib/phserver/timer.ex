defmodule Phserver.Timer do
  ...
  def init(_state) do
    PhserverWeb.Endpoint.subscribe "timer:start", []
    PhserverWeb.Endpoint.subscribe "timer:stop", []
  ...
  defp broadcast(tick, response) do
    PhserverWeb.Endpoint.broadcast! "timer:update", "update_timer_tick", %{
      response: response,
      time: tick,
    }
  end
